...
struct User:Identifiable{
    ...
    init(id:Int, name:String, company:String, workingYear:Int, hashTag:[String], mentoringStatus:Bool){
        self.id = id
        self.name = name
    ...
    mutating func changeMentoringStatus(){
        self.mentoringStatus = true
    }
